...
- Add `InverseDynamics` class (with nested `EvalType` flags) and `eval_inverse_dynamics` function for joint-space mass matrix and gravity/Coriolis compensation forces
